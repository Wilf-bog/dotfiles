:PROPERTIES:
:ID:       ac0b83e1-602d-4fdd-aeb5-45d797d71a36
:END:
...
:PROPERTIES:
:ID:       98ac6540-9bf9-4557-908e-9144db5014f2
:END:
...
We then disable ~package~ to avoid conflicts with ~elpaca~.

#+begin_src emacs-lisp :tangle "early-init.el"
(setq package-enable-at-startup nil)
#+end_src

Some settings necessary for org-gtd
...
They are currently disabled since I'm switching to elpaca.
...
:PROPERTIES:
:ID:       87c97ca1-b882-4c80-a068-db2eef5346d8
:END:
...
** COMMENT Hiding titlebar
#+begin_src emacs-lisp :tangle init.el
  (add-to-list 'default-frame-alist '(undecorated . t))
#+end_src
** Setting up ~elpaca~
:PROPERTIES:
:ID:       a6ff5b9d-83f7-4ba5-aa71-ce640218dc21
:END:
#+begin_src emacs-lisp :tangle init.el
...
** =which-key=
:PROPERTIES:
:ID:       2f2f73a5-a5ec-4133-9bea-fc47c9a014d6
:END:
...
:PROPERTIES:
:ID:       9c59311e-3bbf-44e3-825a-1f5ae075d46b
:END:
...
:PROPERTIES:
:ID:       91fbb6eb-7ba2-4535-9b48-b6987bf40b84
:END:
...
** Save last place visited in a butter
:PROPERTIES:
:ID:       3c2acc75-cdfa-4577-8f01-aaf2e3bcbcba
:END:
#+begin_src emacs-lisp :tangle init.el
  (save-place-mode 1)
#+end_src
** Marks
:PROPERTIES:
:ID:       425fcaf2-fa12-4b36-8d22-e41b32e484ee
:END:
:PROPERTIES:
:ID:       4273c4c8-f63c-412e-b1d3-1b1cf951aa2e
Inspired by this video [[https://www.youtube.com/watch?v=uhyr8kvKa2I][Efficiency With The Mark Ring in Emacs - EP2 -
YouTube]].
...
** Emacs custom-file
:PROPERTIES:
:ID:       087d146d-13f1-463b-b745-0a9f8e5c00c3
:END:
...
:PROPERTIES:
:ID:       f2b05610-2cc9-4796-ae5d-927fb0b845a3
:END:
...
** Emacs tabs
:PROPERTIES:
:ID:       c58a071e-711f-40e3-84d8-c9aec139438c
:END:
...
:PROPERTIES:
:ID:       a3d49229-62f4-4e1d-9683-bea52dcd3975
:END:
...
:PROPERTIES:
:ID:       a9d7d689-de94-4a92-b5e2-8b6efe6ec032
:END:
...
:PROPERTIES:
:ID:       06aae92d-e34b-4db8-ba01-18ae7047de56
:END:
...
*** TODO Modus themes
:PROPERTIES:
:ID:       a0f454a4-1c99-424b-9140-56e9ed8bdcc9
:END:
...
*** Auto-dark
:PROPERTIES:
:ID:       e9cd9943-0d93-4e2d-9b9a-67cafd4965f8
:END:
...
** Recent files
:PROPERTIES:
:ID:       c4dec046-0c14-448b-9d54-f2e06ef46a34
:END:
...
** TODO Text mode
:PROPERTIES:
:ID:       47726620-f620-4d6a-9125-f14f617ed822
:END:
...
:PROPERTIES:
:ID:       3e0eef99-82d2-41d4-9387-a34d015b854a
:END:
...
** Dired
:PROPERTIES:
:ID:       37757adb-2cf5-4702-8777-d6558f6d3451
:END:
...
*** TODO Look and feel
:PROPERTIES:
:ID:       770bd131-f900-4eb6-945e-462587b63810
:END:
...
*** TODO Tagging todos
:PROPERTIES:
:ID:       9ea08a8a-94c0-4558-9b00-e66fbbfbf9b3
:END:
...
*** TODO Agenda
:PROPERTIES:
:ID:       8f6b0096-d833-4d79-99be-b026a3b389f7
:END:
...
*** TODO Habits
:PROPERTIES:
:ID:       441a151f-374f-4bb6-aed2-e078fb0e5df9
:END:
...
*** Notes drawer
:PROPERTIES:
:ID:       5d4be2c1-60ed-43c8-8eed-38a4f405fb68
:END:
...
*** Speed
:PROPERTIES:
:ID:       ce5bf3c5-860f-4da7-815f-b24a95f78dcb
:END:
Based on Emacs Elements tutorial that can be found here: [[https://www.youtube.com/watch?v=QNzNR-K2biI][Org Speed
Commands #emacs #orgmode #programming #coding - YouTube]]
...
** TODO Bibtex
:PROPERTIES:
:ID:       227a1cb0-95db-4ce0-9fcc-a35f5ed2dcd7
:END:
...
** TRAMP
:PROPERTIES:
:ID:       629afe0b-9989-4b24-bf69-a6e3d31cccc5
:END:
...
*** Icons (=all-the-icons=)
:PROPERTIES:
:ID:       43dbd8fe-5040-452e-aa7a-f34a003b3420
:END:
...
*** Variable pitch
:PROPERTIES:
:ID:       0e925707-0b75-49d6-b89c-04a85957b633
:END:
...
*** Fontaine
:PROPERTIES:
:ID:       05d67abf-538e-4387-8648-9e8716b20354
:END:
...
** Eat
:PROPERTIES:
:ID:       58f7e10a-452c-4d89-8ede-6ee14265f8c6
:END:
#+begin_src emacs-lisp :tangle init.el
(use-package eat
  :elpaca
...
** Personal scripts
:PROPERTIES:
:ID:       b897125b-2c66-4cd6-b76c-63ce6d3f09ca
:END:
...
*** Wilf-cosmic-fullscreen
:PROPERTIES:
:ID:       72168d94-da8e-45fd-bc86-04be65137258
:END:
#+begin_src emacs-lisp :tangle init.el
...
** Transient
:PROPERTIES:
:ID:       7c90e4f9-4a9a-4fed-84d7-202e61a28a00
:END:
#+begin_src emacs-lisp :tangle "init.el"
...
** TODO Git
:PROPERTIES:
:ID:       35943844-edc9-4ebc-8f39-717074caecbb
:END:
...
*** TODO COMMENT Casual and Org-agenda
:PROPERTIES:
:ID:       4f6245ad-807a-4b6e-a164-e2f6f0ac7c3e
:END:
...
** TODO Calibre
:PROPERTIES:
:ID:       44b61146-9b6f-4ac6-ada1-dbaa8d276ae1
:END:
#+begin_src emacs-lisp :tangle init.el
...
:PROPERTIES:
:ID:       54751127-3492-4618-9b00-bc6fc178b323
:END:
...
*** Consult-denote
:PROPERTIES:
:ID:       51be6b72-8371-41f6-b088-0b8c6eef40b2
:END:
...
*** TODO Consult-notes
:PROPERTIES:
:ID:       69c1b3ac-635b-4cbc-88a7-b73af636d302
:END:
...
*** Denote-silo
:PROPERTIES:
:ID:       f5a1bebc-e6b9-4f22-902e-759ea4b4b398
:END:
...
*** TODO Denote Org
:PROPERTIES:
:ID:       18ffb055-385d-4ce1-9dd0-bdf62687f3ad
:END:
...
*** Denote journal
:PROPERTIES:
:ID:       bb3b4403-0c12-4cc5-999e-556af6c1a690
:END:
...
:PROPERTIES:
:ID:       d6b9e608-d0cb-4061-b607-3969ef555c96
:END:
...
:PROPERTIES:
:ID:       e7d4f3e1-21a4-4819-8a41-a63f2f459da7
:END:
...
:PROPERTIES:
:ID:       cceef9dc-6c94-431e-b443-55c3bdd02d40
:END:
...
** Biblio
:PROPERTIES:
:ID:       7a0827c8-f52a-4d0e-9c98-544d151f8f49
:END:
...
** Ebib
:PROPERTIES:
:ID:       2e404a1f-7088-49c4-b9df-40dd682333d3
:END:
...
:PROPERTIES:
:ID:       5d3d425b-6862-4b3e-a174-4df758f7c94b
:END:
...
*** TODO Ef themes
:PROPERTIES:
:ID:       7ddb50b8-208e-47c6-8c82-2cdf3d57b2a3
:END:
...
*** TODO Doric themes
:PROPERTIES:
:ID:       955e355f-2e92-4979-a210-aaaaddb06ece
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** Alabaster
:PROPERTIES:
:ID:       2bb06e7c-62a2-4095-ab7b-7786eb489f94
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** Modus-vague
:PROPERTIES:
:ID:       3c17701e-cd0b-44f9-9253-b41f8b04cf13
:END:
#+begin_src emacs-lisp :tangle init.el
...
** Modeline
:PROPERTIES:
:ID:       17ae78b4-1865-4dc7-b499-6f70af67b40d
:END:
...
** Winpulse
:PROPERTIES:
:ID:       a2ad63db-72e6-4a8f-b6a1-24a9f5fa83d7
:END:
...
*** dired-preview
:PROPERTIES:
:ID:       247b868e-8e64-42e6-9d41-3584ebb35fac
:END:
...
*** all-the-icons-dired
:PROPERTIES:
:ID:       11f1e746-6f7e-4b38-92e8-97612b3a3841
:END:
...
*** dired-subtree
:PROPERTIES:
:ID:       af317de8-9490-4c3e-8d8e-1bfd547d60b5
:END:
...
*** TODO Vertico
:PROPERTIES:
:ID:       284efc23-d321-4241-a599-38ca416a694d
:END:
...
*** TODO Orderless
:PROPERTIES:
:ID:       7b288e62-3c2e-48e1-a0fb-4c1277282ad9
:END:
...
*** TODO Marginalia
:PROPERTIES:
:ID:       dc878ac3-3800-4d0c-a4b9-f7b65c56d463
:END:
...
*** TODO Consult
:PROPERTIES:
:ID:       4d8fd028-52c9-483b-b6c7-0369a31b199c
:END:
...
*** Org-tempo
:PROPERTIES:
:ID:       d3fbf0b7-8ed9-4ff1-9842-1d1f7c8bf74d
:END:
...
*** Org-modern
:PROPERTIES:
:ID:       89e92502-664b-4806-b4d4-02c4e767ada7
:END:
...
*** Org-download
:PROPERTIES:
:ID:       afaf375e-9f21-4c57-9442-ffd935876acd
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** Org-appear
:PROPERTIES:
:ID:       5a5d0424-eb8d-4096-a05b-e1a9fd29540b
:END:
...
*** TODO Org-web-tools
:PROPERTIES:
:ID:       ca6ea8bb-e571-4816-ad00-9b27e6f5e404
:END:
...
*** Org-noter
:PROPERTIES:
:ID:       eaf90dc5-8ec0-43c0-b43f-087d02119bec
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** Djvu
:PROPERTIES:
:ID:       1d98301e-f5f3-476c-92ba-20efc0b100d4
:END:
Necessary for =org-noter=.
...
*** Org cite
:PROPERTIES:
:ID:       890387fe-ba07-4800-9990-10b8838838c2
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** TODO Embark
:PROPERTIES:
:ID:       195a339a-48c7-4413-b542-f4679daab43d
:END:
#+begin_src emacs-lisp :tangle init.el
  (use-package embark
    :ensure t
...
:PROPERTIES:
:ID:       40fb3efa-8f96-429e-bb4d-6bd78b79931b
:END:
...
*** TODO Olivetti
:PROPERTIES:
:ID:       3293f69d-8fea-4e25-a07d-c1864cda8cc3
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** TODO Jinx
:PROPERTIES:
:ID:       410861f1-e226-4f7d-9dca-e4c7c83bbd94
:END:
#+begin_src emacs-lisp :tangle init.el
  (use-package jinx
    :ensure t
...
*** TODO Elfeed
:PROPERTIES:
:ID:       62544885-461c-40b0-8886-bc34ceb194cd
:END:
...
*** TODO Tempel
:PROPERTIES:
:ID:       1fec6666-2242-496f-b986-796687ba5860
:END:
...
*** TODO Ledger
:PROPERTIES:
:ID:       fe5971d6-8d76-4562-add2-652a521c214b
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** TMR
:PROPERTIES:
:ID:       dd23ba71-3299-43b2-8fe9-8065a4244c3e
:END:
Based on Prot's video tutorial and explanations found here: [[https://protesilaos.com/codelog/2026-01-19-emacs-timers-tmr-demo/][Emacs:
easily set timers with TMR | Protesilaos Stavrou]].
...
*** TODO PDF
:PROPERTIES:
:ID:       0b3fa809-ddf4-4bde-945c-3055be0e6dbd
:END:

I do use PDFs regularly and I appreciate the ability to access them
...
I want to eventually migrate to emacs-reader, which should replace
most book formats. It doesn't play well with annotations for now, so
I'll still need pdf-tools.
...
*** Epub
:PROPERTIES:
:ID:       44989523-3d9f-4d47-b788-330e61e388a3
:END:
...
*** TODO Odt
:PROPERTIES:
:ID:       78fa17a8-f272-4b9e-869c-4fa8ae4a2304
:END:
...
*** TODO Video
:PROPERTIES:
:ID:       4d9b756c-903e-4907-924c-348cfc26ea4c
:END:
