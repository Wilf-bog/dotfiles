...
** Setting Use-package
:PROPERTIES:
:ID:       3470f33d-4028-44fe-b8dc-a6deafcab59e
:END:
...
** Setting Straight
:PROPERTIES:
:ID:       517355b7-dd1b-40a9-be95-e882cd80c8bb
:END:
I've started using =straight= to be able to install the beta version of
=org-gtd=. I still need to see if this is something I want to use in the
future.
...
To avoid mismatching versions of Org loaded, the following line is
necessary:
