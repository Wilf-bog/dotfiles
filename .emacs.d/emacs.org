...
<<<<<<< HEAD
        '((sequence "TODO(t)" "NEXT(n)" "STARTED(s!)" "WAITING(w)" "|" "DONE(d@/@)" "DELEGATED(ÔøΩ@/@)" "CANCELED(c@/@)")))
=======
	'((sequence "TODO" "NEXT" "WAITING" "|" "DONE" "DELEGATED" "CANCELED")))
>>>>>>> 14b46ce5326ac9262f66b78d6fb23a4a5e5d25ec
=======
          ;; Activities
          ("@mÈnage" . ?m)
          ("@lecture" . ?l)
  ...
  ;; More TODO states
  (setq org-todo-keywords
        '((sequence "TODO(t)" "NEXT(n)" "STARTED(s!)" "WAITING(w)" "|" "DONE(d@/@)" "DELEGATED(È@/@)" "CANCELED(c@/@)")))
>>>>>>> Stashed changes
