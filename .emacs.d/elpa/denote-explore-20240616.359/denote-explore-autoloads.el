...
Order the keywords of all Denote notes and attachments alphabetically." t)
...
Use empty string as new keyword to remove the selection." t)
(autoload 'denote-explore-sync-metadata "denote-explore" "\
Synchronise the filenames with the metadata for all Denote files.

Set `denote-rename-buffer-mode' to ensure synchronised notes." t)
(autoload 'denote-explore-keywords-barchart "denote-explore" "\
Create a barchart with the top N most used Denote keywords.

(fn N)" t)
(autoload 'denote-explore-extensions-barchart "denote-explore" "\
Visualise the Denote file and attachment types." t)
(autoload 'denote-explore-degree-barchart "denote-explore" "\
Visualise the number of degrees for each node in the Denote network." t)
